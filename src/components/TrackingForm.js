    ...
    return (
      <Form>
        <FormGroup row>
          ...
          <Col sm={9} md={8}>
            <Input type="text" name="trackingNumber" id="trackingNumber" placeholder="RF708439738CN" onChange={value => this.onTrackingNumberTextChange.bind(this)(value)} />
          </Col>
        </FormGroup>
        <FormGroup row>
          ...
          <Col sm={{ size: 12, offset: 2}}>
              ...
              <br/>
              <Col sm={9} md={8}>
                <Input type="text" name="captchaText" id="captchaText" placeholder="ABC123" onChange={value => this.onCaptchaTextChange.bind(this)(value)} />
                <FormText>
